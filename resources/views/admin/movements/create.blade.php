    ...
    <div class="card-body">
        <form action="{{ route("admin.movements.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('location') ? 'has-error' : '' }}">
                ...
                <input type="text" id="location" name="location" class="form-control" value="{{ old('location', isset($product) ? $product->location : '') }}">
                </div>
            ...
            <div class="form-group {{ $errors->has('verifier') ? 'has-error' : '' }}">
                ...
                <input type="text" id="verifier" name="verifier" class="form-control" value="{{ old('verifier', isset($product) ? $product->verifier : '') }}">
                </div>
